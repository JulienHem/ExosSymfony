 ...
 */
final class Version20200804131605 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, supplier_id_id INT DEFAULT NULL, product_name VARCHAR(40) NOT NULL, category_id SMALLINT NOT NULL, quantity_per_unit INT NOT NULL, unit_price INT NOT NULL, units_in_stock INT NOT NULL, units_on_order INT NOT NULL, reorder_level INT NOT NULL, discontinued INT NOT NULL, product_id INT NOT NULL, INDEX IDX_B3BA5A5AA65F9C7D (supplier_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
